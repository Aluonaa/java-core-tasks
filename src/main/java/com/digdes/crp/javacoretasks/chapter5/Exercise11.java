...
public class Exercise11 {
    ...
    Кроме того: таким образом, местоположение, из которого генерируется исключение,
    ...
    мы можем реализовать следующее:
     ...
     Утвержденияудаляются во время выполнения, если при компиляции кода явно не указано
