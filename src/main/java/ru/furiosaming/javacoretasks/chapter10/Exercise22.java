...
public class Exercise22 {
    ...
    public class Stack {
     ...
     Решение: в данном случае передавать переменную myLock в блок synchronized будет ошибкой.
     Для неё в оперативной памяти компьютера выделяется определенное место.
